...
visualization_with_zoom(Y, zoom, colorbar, f'results/{config.initial_regularization_method}.pdf')
...
for model_name in ["fbp_resnet", f"{config.initial_regularization_method}_resnet", "fbp_nsn", f"{config.initial_regularization_method}_nsn", f"{config.initial_regularization_method}_dpnsn"]:
...
error_table.to_csv(f"results/{config.initial_regularization_method}_error_table.csv")
print(f"Finished.")    
